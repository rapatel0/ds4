...
- [ ] Matrix harness exists and has documented usage.
- [ ] Harness validates required inputs and block sizes.
- [ ] Harness writes per-case logs, TSV, and Markdown summary.
- [ ] Local shell validation passes.
- [ ] V100 matrix runs on the production appliance pack.
- [ ] Logs are copied to
      `logs/from-cluster/sprint223-mtp-acceptance-matrix/`.
- [ ] Docs state whether MTP accepted-prefix evidence justifies another MTP
