...
struct RankState {
    ...
    float *d_attn_raw_swa_layers[44] = {};  /* +1 for the MTP block at layer 43 */
    ...
    float *d_attn_comp_state_kv_layers[44] = {};
    float *d_attn_comp_state_score_layers[44] = {};
    float *d_attn_comp_rows_layers[44] = {};
    uint32_t attn_comp_rows_written_layers[44] = {};
    uint64_t attn_comp_row_position_layers[44][kBoundedCompRows] = {};
    uint64_t attn_comp_row_loaded_position_layers[44][kBoundedCompRows] = {};
    bool attn_comp_row_loaded_layers[44][kBoundedCompRows] = {};
    ...
    float *d_index_comp_state_kv_layers[44] = {};
    float *d_index_comp_state_score_layers[44] = {};
    float *d_index_comp_rows_layers[44] = {};
    uint32_t index_comp_rows_written_layers[44] = {};
    uint64_t index_comp_row_position_layers[44][kBoundedCompRows] = {};
    uint64_t index_comp_row_loaded_position_layers[44][kBoundedCompRows] = {};
    bool index_comp_row_loaded_layers[44][kBoundedCompRows] = {};
