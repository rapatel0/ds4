...
typedef struct {
    ds4_tp_gpu_report gpu[DS4_V100_TP_MAX_GPUS];
} ds4_tp_runtime_report;

typedef struct ds4_tp_runtime ds4_tp_runtime;
...
typedef struct {
    ...
    uint64_t checksum;
} ds4_tp_kv_row_roundtrip_result;
...
typedef struct {
    ...
    uint32_t bad_values;
    uint64_t checksum;
} ds4_tp_kv_device_roundtrip_result;
...
typedef struct {
    ...
    double max_abs;
} ds4_tp_dense_kv_result;

void ds4_tp_runtime_default_config(ds4_tp_runtime_config *cfg);

int ds4_tp_runtime_open(ds4_tp_runtime **out,
                             const ds4_tp_runtime_config *cfg,
                             char *err,
                             size_t err_len);

int ds4_tp_runtime_fixture(ds4_tp_runtime *rt,
                                double *max_abs,
                                char *err,
                                size_t err_len);

int ds4_tp_runtime_dense_kv_slice(ds4_tp_runtime *rt,
                                       int layer,
                                       uint32_t slot,
                                       uint64_t position,
                                       int write_indexer,
...
int ds4_tp_runtime_kv_row_view(ds4_tp_runtime *rt,
                                    int layer,
                                    uint32_t slot,
                                    uint64_t position,
                                    ds4_tp_kv_row_kind kind,
...
int ds4_tp_runtime_kv_row_roundtrip_f32(ds4_tp_runtime *rt,
                                             int layer,
                                             uint32_t slot,
                                             uint64_t position,
                                             ds4_tp_kv_row_kind kind,
...
int ds4_tp_runtime_kv_row_store_f32_device(
    ds4_tp_runtime *rt,
    int layer,
    uint32_t slot,
    uint64_t position,
...
int ds4_tp_runtime_kv_row_load_f32_device(
    ds4_tp_runtime *rt,
    int layer,
    uint32_t slot,
    uint64_t position,
...
int ds4_tp_runtime_kv_rows_store_f32_device(
    ds4_tp_runtime *rt,
    int layer,
    uint32_t first_slot,
    uint32_t slot_count,
...
int ds4_tp_runtime_kv_rows_store_f32_device_streams(
    ds4_tp_runtime *rt,
    int layer,
    uint32_t first_slot,
    uint32_t slot_count,
...
int ds4_tp_runtime_kv_rows_store_f32_device_streams_at_position(
    ds4_tp_runtime *rt,
    int layer,
    uint32_t first_slot,
    uint32_t slot_count,
...
int ds4_tp_runtime_kv_rows_load_f32_device_streams(
    ds4_tp_runtime *rt,
    int layer,
    uint32_t first_slot,
    uint32_t slot_count,
...
int ds4_tp_runtime_kv_rows_load_f32_device_streams_at_position(
    ds4_tp_runtime *rt,
    int layer,
    uint32_t first_slot,
    uint32_t slot_count,
...
void ds4_tp_runtime_get_report(const ds4_tp_runtime *rt,
                                    ds4_tp_runtime_report *report);

void ds4_tp_runtime_close(ds4_tp_runtime *rt);
