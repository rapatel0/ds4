...
int ds4_gpu_enable_peer_access(int gpu_a, int gpu_b);
...
int ds4_gpu_arena_f8_e4m3_b128_row_decode_f32(
        ...
        float                          *out_f32,
        uint64_t                        out_bytes);
int ds4_gpu_arena_f8_e4m3_b128_matmul_f32(
        const ds4_gpu_arena           *arena,
        const ds4_gpu_source_row_view *view,
        const ds4_gpu_tensor          *x_f32,
        ds4_gpu_tensor                *out_f32);
int ds4_gpu_arena_f8_e4m3_b128_matmul_add_f32(
        const ds4_gpu_arena           *arena,
        const ds4_gpu_source_row_view *view,
        const ds4_gpu_tensor          *x_f32,
...
int ds4_gpu_arena_f8_e4m3_b128_matmul_batch_f32(
        ...
        uint32_t                       n_tokens,
        ds4_gpu_tensor                *out_f32);
int ds4_gpu_arena_f8_e4m3_b128_matmul_batch_add_f32(
        const ds4_gpu_arena           *arena,
        const ds4_gpu_source_row_view *view,
        const ds4_gpu_tensor          *x_f32,
        uint32_t                       n_tokens,
...
int ds4_gpu_arena_f8_e4m3_b128_matmul_grouped_f32(
        ...
        ds4_gpu_tensor                *out_f32);
int ds4_gpu_arena_f8_e4m3_b128_matmul_grouped_batch_f32(
        const ds4_gpu_arena           *arena,
        const ds4_gpu_source_row_view *view,
        const ds4_gpu_tensor          *x_f32,
        uint32_t                       n_tokens,
...
int ds4_gpu_arena_mxfp4_matmul_f32(
        ...
        const ds4_gpu_tensor          *x_f32,
        ds4_gpu_tensor                *out_f32);
int ds4_gpu_arena_mxfp4_pair_swiglu_f32(
        const ds4_gpu_arena           *arena,
        const ds4_gpu_source_row_view *gate,
        const ds4_gpu_source_row_view *up,
        const ds4_gpu_tensor          *x_f32,
        ...
        float                          clamp,
        float                          weight);
int ds4_gpu_arena_mxfp4_matmul_add_f32(
        const ds4_gpu_arena           *arena,
        const ds4_gpu_source_row_view *view,
        const ds4_gpu_tensor          *x_f32,
        const ds4_gpu_tensor          *add_f32,
        ds4_gpu_tensor                *out_f32);
int ds4_gpu_arena_mxfp4_routed_swiglu_down_sum_f32(
        const ds4_gpu_arena *arena,
        ...
        ds4_gpu_tensor *out_f32);
int ds4_gpu_arena_mxfp4_routed_swiglu_down_sum_batch_f32(
        const ds4_gpu_arena *arena,
        uint64_t gate_arena_offset,
        uint64_t gate_byte_length,
        uint64_t up_arena_offset,
        ...
        ds4_gpu_tensor *mid_tmp_f32,
        ds4_gpu_tensor *out_f32);
int ds4_gpu_arena_mxfp4_routed_swiglu_down_sum_batch_ptrs_f32(
        const ds4_gpu_arena *arena,
        uint64_t gate_arena_offset,
        uint64_t gate_byte_length,
        uint64_t up_arena_offset,
...
int ds4_gpu_arena_turbomind_mxfp4_routed_swiglu_down_sum_f32(
        ...
        uint32_t n_tokens,
        ds4_gpu_tensor *out_f32);
int ds4_gpu_arena_turbomind_mxfp4_routed_swiglu_down_sum_batch_ptrs_f32(
        const ds4_gpu_arena *arena,
        const ds4_gpu_turbomind_mxfp4_matrix_view *gate,
        const ds4_gpu_turbomind_mxfp4_matrix_view *up,
        const ds4_gpu_turbomind_mxfp4_matrix_view *down,
...
int ds4_gpu_arena_turbomind_mxfp4_routed_gate_up_swiglu_down_sum_f32(
        ...
        uint32_t n_tokens,
        ds4_gpu_tensor *out_f32);
int ds4_gpu_arena_turbomind_mxfp4_routed_gate_up_swiglu_down_sum_batch_ptrs_f32(
        const ds4_gpu_arena *arena,
        const ds4_gpu_turbomind_mxfp4_matrix_view *gate_up,
        const ds4_gpu_turbomind_mxfp4_matrix_view *down,
        uint32_t hidden,
