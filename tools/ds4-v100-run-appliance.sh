...
case "$DS4_V100_TURBOMIND_ROUTED_EXECUTOR" in
    ...
    *) fail "DS4_V100_TURBOMIND_ROUTED_EXECUTOR must be off, auto, fixed96, fixed768, fixed6, or fused6" ;;
esac
