#!/bin/bash
# Sprint 604 run wrapper (pod-side): wait-for-idle + foreign-process
...
#   ART_DIR      artifact root (default /workspace/s604-artifacts)
...
tokens="${TOKENS:-64}"
slots="${SLOTS:-32}"
art="${ART_DIR:-/workspace/s604-artifacts}"
log="$art/$name"
